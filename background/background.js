    ...
    if (activeTabId) {
      ...
      stylesForWindow.set(windowId, `
        .tabs#window-${windowId}::after {
          height: calc((100% - var(--pinned-tabs-area-size) - var(--subpanel-area-size) - var(--after-tabs-area-size)) / ${visibleItems.length});
          top: calc(var(--pinned-tabs-area-size) + ((100% - var(--pinned-tabs-area-size) - var(--subpanel-area-size) - var(--after-tabs-area-size)) / ${visibleItems.length} * ${position}));
        }
      `);
    }
    else {
